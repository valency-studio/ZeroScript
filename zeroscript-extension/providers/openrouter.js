...
// providers/openrouter.js - OpenRouter provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("OpenRouter input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "openrouter", ready: !!getEditor() });
  ...
  return {
    id: "openrouter", displayName: "OpenRouter", supportsVision: true,
