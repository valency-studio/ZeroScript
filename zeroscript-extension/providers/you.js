...
// providers/you.js - You.com provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  const S = {
  "turn": "[data-testid*=\"message\"], [class*=\"ChatMessage\"], [class*=\"chat-turn\"]",
  "user": "[data-testid*=\"user\"], [class*=\"UserMessage\"]",
  "asst": "[data-testid*=\"assistant\"], [class*=\"AgentMessage\"]",
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("You.com input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "you", ready: !!getEditor() });
  ...
  return {
    id: "you", displayName: "You.com", supportsVision: true,
