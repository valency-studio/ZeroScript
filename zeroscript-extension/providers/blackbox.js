...
// providers/blackbox.js - Blackbox provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  const S = {
  "turn": "[class*=\"message\"], [data-testid*=\"message\"]",
  "user": "[class*=\"user\"], [data-message-author-role=\"user\"]",
  "asst": "[class*=\"assistant\"], [data-message-author-role=\"assistant\"]",
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Blackbox input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "blackbox", ready: !!getEditor() });
  ...
  return {
    id: "blackbox", displayName: "Blackbox", supportsVision: true,
