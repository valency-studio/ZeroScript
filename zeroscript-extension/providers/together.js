...
// providers/together.js - Together AI provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Together AI input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "together", ready: !!getEditor() });
  ...
  return {
    id: "together", displayName: "Together AI", supportsVision: true,
