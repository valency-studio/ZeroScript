...
//
// last validated: 2026-07 — chat.z.ai
// Z.ai (GLM) DOM notes:
...
const ZSProvider = (() => {
  ...
  function modeWarning() {
    try {
      if (!getEditor()) return "GLM composer not found — open a New chat on chat.z.ai or refresh.";
    } catch {}
    return "";
  }
  function unstableWarning() {
    return "When z.ai is busy you may see \"No response, please try again later\" — retry in a moment or pick GLM-5.2.";
  }
