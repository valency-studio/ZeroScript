...
// providers/cohere.js - Cohere Coral provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Cohere Coral input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "cohere", ready: !!getEditor() });
  ...
  return {
    id: "cohere", displayName: "Cohere Coral", supportsVision: true,
