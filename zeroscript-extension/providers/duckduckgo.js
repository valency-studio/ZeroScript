...
// providers/duckduckgo.js - Duck.ai provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  const S = {
  "turn": "[data-testid*=\"message\"], [class*=\"message\"]",
  "user": "[data-testid*=\"user\"], [class*=\"user\"]",
  "asst": "[data-testid*=\"assistant\"], [class*=\"assistant\"]",
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Duck.ai input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "duckduckgo", ready: !!getEditor() });
  ...
  return {
    id: "duckduckgo", displayName: "Duck.ai", supportsVision: true,
