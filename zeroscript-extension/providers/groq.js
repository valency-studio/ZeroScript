...
// providers/groq.js - Groq provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Groq input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "groq", ready: !!getEditor() });
  ...
  return {
    id: "groq", displayName: "Groq", supportsVision: true,
