...
// providers/huggingchat.js - HuggingChat provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("HuggingChat input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "huggingchat", ready: !!getEditor() });
  ...
  return {
    id: "huggingchat", displayName: "HuggingChat", supportsVision: true,
