...
// main.js AI_SITES).
//
// last validated: 2026-07 — chat.qwen.ai
// Qwen DOM notes:
...
const ZSProvider = (() => {
  ...
  function modeWarning() {
    try {
      if (!getEditor()) return "Qwen composer not found — open chat.qwen.ai and start a New chat or refresh.";
    } catch {}
    return "";
  }
  function unstableWarning() {
    return "Avoid Qwen's side-by-side compare mode — it splits replies and breaks turn detection.";
  }
