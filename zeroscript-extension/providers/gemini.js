...
//
// last validated: 2026-07 — gemini.google.com
// Gemini DOM notes:
...
const ZSProvider = (() => {
  ...
  function modeWarning() {
    try {
      if (!getEditor()) return "Gemini composer not found — open a New chat or refresh.";
    } catch {}
    return "";
  }
  function unstableWarning() {
    return "In long sessions Gemini may answer in plain text instead of tool commands — start a new chat if it stops acting in Studio.";
  }
