...
// providers/pi.js - Pi provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  "user": "[class*=\"user\"], [data-testid*=\"user\"]",
  "asst": "[class*=\"assistant\"], [class*=\"pi-\"], [data-testid*=\"assistant\"]",
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Pi input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "pi", ready: !!getEditor() });
  ...
  return {
    id: "pi", displayName: "Pi", supportsVision: true,
