...
// providers/phind.js - Phind provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  "asst": "[class*=\"assistant\"], [data-role=\"assistant\"]",
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("Phind input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "phind", ready: !!getEditor() });
  ...
  return {
    id: "phind", displayName: "Phind", supportsVision: true,
