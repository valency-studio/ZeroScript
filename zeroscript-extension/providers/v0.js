...
// providers/v0.js - v0 provider (heuristic DOM).
...
const ZSProvider = (() => {
  ...
  async function typeAndSend(text, images) {
    const ed = getEditor(); if (!ed) throw new Error("v0 input box not found");
  ...
  async function ensureComposerReady(reason) {
    diag("mode_ready", { reason, provider: "v0", ready: !!getEditor() });
  ...
  return {
    id: "v0", displayName: "v0", supportsVision: true,
