...
(() => {
  ...
  const GITHUB_URL = "https://github.com/valency-studio/ZeroScript";
  ...
  // safelinku locked link - free "watch an ad" support option. Set once the
  // locker is created at https://safelinku.com/; the button is hidden until then.
  ...
  // `name` must equal the provider's displayName for the "active" badge.
  const AI_SITES = [
    ...
    { name: "LMSYS Chatbot Arena", url: "https://chat.lmsys.org/" },
    ...
    { name: "Together AI", url: "https://chat.together.ai/" },
  ...
  const ui = (() => {
    ...
    function build() {
      ...
      root.innerHTML = `
        <div id="zs-bar">
          ...
          <button id="zs-switch" aria-label="Switch AI and options" title="I, custom prompt, support"><span id="zs-switch-name"></span><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></button>
    ...
    // prompt, and support (Trakteer + Robux). Opens above the bar.
    function buildMenu() {
      ...
      menuEl.innerHTML =
        `<div class="zs-menu-head"><span class="zs-menu-logo">ZeroScript</span><span class="zs-menu-tag">v${EXT_VERSION}</span></div>
         ...
         <section class="zs-menu-sec">
           ...
           ${SAFELINKU_URL ? `<button class="zs-tip-opt zs-tip-ad" data-u="${SAFELINKU_URL}"><span>Watch an ad to support</span><span class="zs-tip-sub">free, takes a minute</span></button>` : ""}
         </section>
         <section class="zs-menu-sec">
           <div class="zs-sec-label"><span>Support with Robux / Trakteer</span></div>
           <button class="zs-tip-opt zs-tip-trakteer" data-u="${TRAKTEER_URL}"><span>Tip on Trakteer</span><span class="zs-tip-sub">any amount</span></button>
